        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden min-h-[600px] lg:min-h-[700px]">
          ...
          <div className="flex flex-col lg:flex-row h-full">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-cover bg-center bg-no-repeat relative min-h-[400px] lg:min-h-full"
              style={{ backgroundImage: "url('https://images.unsplash.com/photo-1746766414005-ee349f5f12bf?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}>
              <div className="absolute inset-0 bg-black/40"></div>
              <div className="absolute inset-0 bg-gradient-to-l from-transparent to-[#1E88E5]/20"></div>
